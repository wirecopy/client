...
The root [README](../README.md) contains the short product overview. Detailed
research lives in the focused documents listed there.

Recommended reading order:

1. [Product thesis](product-thesis.md)
2. [Competitive landscape](competitive-landscape.md)
3. [Differentiation](differentiation.md)
4. [Validation plan](validation-plan.md)
5. [macOS experience](macos-experience.md)
